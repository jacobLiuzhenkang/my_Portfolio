...
window.projects = [
    ...
    // 🔵 示例 5：IP 延展
    {
        ...
        title: '夏商 IP 延展设计',
        subtitle: '周边物料 · 表情包',
        tags: ['Merch', 'Sticker', 'Branding'],
        coverImage: '',
        color: 'from-cyan-500 to-blue-500',
        featured: false,
        demoUrl: '',
        description: 'IP 形象在节日海报与周边产品中的应用延展。',
    ...
    // 🔵 示例 6：3D 场景
    {
        ...
        type: 'visual', 
        title: '夏商 IP 三维场景',
        subtitle: 'C4D 建模 · 场景搭建',
        tags: ['3D Scene', 'C4D', 'Rendering'],
        coverImage: '',
        color: 'from-indigo-500 to-purple-500',
        featured: false,
        demoUrl: '',
        description: '为 IP 形象搭建的专属 3D 运营场景。',
        markdownFile: './posts/project6.md' 
    }
];